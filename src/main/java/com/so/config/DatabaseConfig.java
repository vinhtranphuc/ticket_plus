...
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
    	...
    	dataSource.setUrl("jdbc:mysql://127.0.0.1:3306/ticket-plus?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&zeroDateTimeBehavior=convertToNull");
